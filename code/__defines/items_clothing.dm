...
var/list/slim_onmob_icons = list(
		slot_l_hand_str = 'icons/mob/items/lefthand.dmi',
		slot_r_hand_str = 'icons/mob/items/righthand.dmi',
		slot_belt_str = 'icons/mob/slim/belt.dmi',
		slot_back_str = 'icons/mob/slim/back.dmi',
		slot_l_ear_str = 'icons/mob/ears.dmi',
		slot_r_ear_str = 'icons/mob/ears.dmi',
		slot_glasses_str = 'icons/mob/slim/eyes.dmi',
		slot_wear_id_str = 'icons/mob/mob.dmi',
		slot_w_uniform_str = 'icons/mob/slim/uniform.dmi',
		slot_wear_suit_str = 'icons/mob/slim/suit.dmi',
		slot_head_str = 'icons/mob/head.dmi',
		slot_shoes_str = 'icons/mob/slim/feet.dmi',
		slot_wear_mask_str = 'icons/mob/mask.dmi',
		slot_handcuffed_str = 'icons/mob/mob.dmi',
		slot_legcuffed_str = 'icons/mob/mob.dmi',
		slot_gloves_str = 'icons/mob/slim/hands.dmi',
		slot_s_store_str = 'icons/mob/slim/belt_mirror.dmi',
		slot_tie_str = 'icons/mob/slim/ties.dmi'
		)
