...
/datum/category_item/player_setup_item/relations/OnTopic(var/href,var/list/href_list, var/mob/user)
	...
	if(href_list["relation_info"])
		...
		var/info = sanitize(input_utf8("Character info", "What would you like the other party for this connection to know about your character?",pref.relations_info[R]) as message|null)
		if(info)
