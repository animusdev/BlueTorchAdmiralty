	...
	if(href_list["flavor_text"])
		...
		switch(href_list["flavour_text_robot"])
			...
			if("Default")
				...
				var/msg = sanitize(input_cp1251(usr,"Set the flavour text for your robot with [href_list["flavour_text_robot"]] module. If you leave this empty, default flavour text will be used for this module.","Flavour Text",rhtml_decode(pref.flavour_texts_robot[href_list["flavour_text_robot"]])), extra = 0)
				if(CanUseTopic(user))
					pref.flavour_texts_robot[href_list["flavour_text_robot"]] = msg
